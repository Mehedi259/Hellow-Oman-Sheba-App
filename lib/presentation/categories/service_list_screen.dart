...
const Map<String, Map<String, dynamic>> serviceCategoriesData = {
  'ambulance': {
    ...
    'icon': '🚑',
    'description': 'জরুরী অ্যাম্বুলেন্স সেবা এবং মেডিকেল ট্রান্সপোর্ট।',
    'backendName': 'Ambulance',
    'color': 0xFFDC2626,
  },
  'doctors': {
    'nameBn': 'বিশেষজ্ঞ ডাক্তার',
    'icon': '👨‍⚕️',
    'description': 'বিশেষজ্ঞ চিকিৎসক, পরামর্শ এবং চেকআপ সেবা।',
    'backendName': 'Specialist Doctor',
    'color': 0xFF0891B2,
  },
  'hospitals': {
    'nameBn': 'হাসপাতাল',
    'icon': '🏥',
    'description': 'হাসপাতাল, ক্লিনিক এবং মেডিকেল সেন্টার।',
  ...
  'maktab': {
    'nameBn': 'মক্তব সানাদ',
    'icon': '📜',
    'description': 'মক্তব সার্টিফিকেট, শিক্ষা সনদ এবং সংশ্লিষ্ট সেবা।',
    'backendName': 'Maktab Sanad',
    'color': 0xFF7C3AED,
  },
  'travel-agency': {
    'nameBn': 'ট্রাভেল এজেন্সি',
    'icon': '✈️',
    'description': 'ফ্লাইট বুকিং, হোটেল রিজার্ভেশন এবং ট্যুর প্যাকেজ।',
    'backendName': 'Travel Agency',
    'color': 0xFF2563EB,
  },
  'tourist-places': {
    'nameBn': 'দর্শনীয় স্থান',
    'icon': '🗿',
    'description': 'ওমানের দর্শনীয় স্থান, ঐতিহাসিক স্থান এবং পর্যটন।',
    'backendName': 'Tourist Place',
    'color': 0xFFD97706,
  },
  'lawyers': {
    'nameBn': 'আইনজীবী',
    'icon': '⚖️',
    'description': 'আইনজীবী, আইনগত পরামর্শ এবং লেবার কোর্ট সেবা।',
    'backendName': 'Lawyer',
    'color': 0xFF6D28D9,
  },
  'hotels': {
    'nameBn': 'হোটেল',
    'icon': '🏨',
    'description': 'হোটেল, রেস্ট হাউস এবং আবাসন সেবা।',
    'backendName': 'Hotel',
    'color': 0xFF0F766E,
  },
  'money-exchange': {
    ...
    'icon': '💱',
    'description': 'মানি এক্সচেঞ্জ, রেমিট্যান্স এবং ব্যাংকিং সেবা।',
    'backendName': 'Money Exchange',
    'color': 0xFF065F46,
  },
  'police': {
    'nameBn': 'পুলিশ স্টেশন',
    'icon': '👮',
    'description': 'পুলিশ স্টেশন, জরুরী সেবা এবং আইন শৃঙ্খলা।',
    'backendName': 'Police Station',
    'color': 0xFF1E40AF,
  },
  'plumbing': {
    'nameBn': 'প্লাম্বার',
    'icon': '🔧',
    'description': 'প্লাম্বিং সার্ভিস, পানির লাইন এবং পাইপ মেরামত।',
  ...
  'electrical': {
    ...
    'icon': '⚡',
    'description': 'বৈদ্যুতিক কাজ, ওয়ায়ারিং এবং ইলেকট্রিক্যাল মেরামত।',
  ...
  'cleaning': {
    'nameBn': 'ক্লিনিং',
    'icon': '🧹',
    'description': 'বাসা ও অফিস পরিষ্কার সেবা, ডিপ ক্লিনিং।',
  ...
  'ac-repair': {
    'nameBn': 'এসি সার্ভিস',
    'icon': '❄️',
    'description': 'এসি ইন্সটলেশন, সার্ভিসিং এবং মেরামত।',
    'backendName': 'AC Repair',
    'color': 0xFF3B82F6,
  },
  'carpentry': {
    'nameBn': 'কার্পেন্টার',
    'icon': '🪚',
    'description': 'কাঠের কাজ, ফার্নিচার তৈরি ও মেরামত।',
  ...
  'painting': {
    'nameBn': 'রং মিস্ত্রি',
    'icon': '🎨',
    'description': 'বাসা ও অফিসের দেয়াল রং করার সেবা।',
    'backendName': 'Painting',
    'color': 0xFFEC4899,
  },
  'appliance-repair': {
    'nameBn': 'ফ্রিজ সার্ভিস',
    'icon': '🏠',
    'description': 'ফ্রিজ, ওয়াশিং মেশিন এবং গৃহস্থালি যন্ত্রপাতি মেরামত।',
    'backendName': 'Appliance Repair',
    'color': 0xFF10B981,
  },
  'mason': {
    'nameBn': 'রাজমিস্ত্রি',
    'icon': '🧱',
    'description': 'নির্মাণ কাজ, টাইলস এবং ইট-বালির কাজ।',
    'backendName': 'Mason',
    'color': 0xFFF97316,
  },
  'mobile-technician': {
    'nameBn': 'মোবাইল মিস্ত্রি',
    'icon': '📱',
    'description': 'মোবাইল ফোন মেরামত এবং টেকনিক্যাল সাপোর্ট।',
    'backendName': 'Mobile Technician',
    'color': 0xFF6366F1,
  },
  ...
  'insurance': {
    'nameBn': 'ইন্স্যুরেন্স',
    'icon': '🛡️',
    'description': 'বিভিন্ন ইন্স্যুরেন্স কোম্পানির সার্ভিস এবং কভারেজ তথ্য।',
    'backendName': 'Insurance',
    'color': 0xFF1D4ED8,
  },
  'business': {
    'nameBn': 'বিজনেস',
    'icon': '💼',
    'description': 'ব্যবসা প্রতিষ্ঠানের বিজ্ঞাপন এবং সার্ভিস।',
                ...
                background: Container(
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      colors: [
                        catColor,
                        Color.lerp(catColor, Colors.black, 0.3)!,
                      ],
                      ...
                      child: Center(
                        child: Column(
                          ...
                          children: [
                            ...
                            const Text(
                              'এই বিভাগে এখনো কোনো সেবা যোগ করা হয়নি।',
                              style: TextStyle(
              ...
              background: images.isNotEmpty
                            ...
                            child: Row(
                              ...
                              children: images
                                  ...
                                  .map(
                                    (e) => GestureDetector(
                                      onTap: () =>
                                          setState(() => _imgIndex = e.key),
                                      child: AnimatedContainer(
                                        duration: const Duration(
                                          milliseconds: 200,
                                        ),
                                        width: _imgIndex == e.key ? 20 : 6,
                                        height: 6,
                                        margin: const EdgeInsets.symmetric(
                                          horizontal: 3,
                                        ),
                                        decoration: BoxDecoration(
                                          color: _imgIndex == e.key
                                              ? Colors.white
                                              : Colors.white54,
                  ...
                  : Container(
                      ...
                      child: SafeArea(
                        child: Center(
                          child: Text(
                            serviceCategoriesData[widget.slug]?['icon']
                                    as String? ??
                                '🏢',
                        ...
                        children: [
                          Expanded(
                            child: ElevatedButton.icon(
                              onPressed: () async {
                                final phone = s.contactPhone.isNotEmpty
                                    ? s.contactPhone
                                    : s.contactInfo;
